...
public:
    ...
    void printInstructions() {
        cout << endl << "You have entered Manual Driving Mode: Create Map eddition !" << endl << endl;
        ...
        cout << endl << "Thanks, you are at Lat: " << gridLat << ", Long: " << gridLong << ", facing: " << heading << endl;
        
        cout << "Press w-a-s-d Keys to move the robot (DONT FORGET, NEED TO CLICK ON THE MAP TO INPUT KEYS !)" << endl;
        cout << "Happy exploring ! (Press 'm' to see which locations you still need to check)" << endl << endl;
    }
    ...
    void getKeyDirrection() {
        ...
        while (robot.step(timeStep) != -1) {
            key = keyboard.getKey();
            if (key == 78 || key == 69 || key == 83 || key == 87) { break; }
        }
        if (key == 78) {
            heading = 'N';
        }
    ...
    int getKeyPressDrive() {
        ...
        while (robot.step(timeStep) != -1) {
            //cout << "yo" << endl;
            key = keyboard.getKey();
            if (key == 87 || key == 76 || key == 65 || key == 83 || key == 68 || key == 77) { break; }
    ...
    void checkFirstGrid() {
        ...
        if (heading == 'N') {
            ...
            if (obsticalForward == 'N') { gridWalls[gridLocation][0] = 0; }
            else { gridWalls[gridLocation][0] = 1; }

            if (obsticalLeft == 'N') { gridWalls[gridLocation][3] = 0; }
            else { gridWalls[gridLocation][3] = 1; }

            if (obsticalRight == 'N') { gridWalls[gridLocation][1] = 0; }
            else { gridWalls[gridLocation][1] = 1; }

        }
        else if (heading == 'E') {

            if (obsticalForward == 'N') { gridWalls[gridLocation][1] = 0; }
            else { gridWalls[gridLocation][1] = 1; }

            if (obsticalLeft == 'N') { gridWalls[gridLocation][0] = 0; }
            else { gridWalls[gridLocation][0] = 1; }

            if (obsticalRight == 'N') { gridWalls[gridLocation][2] = 0; }
            else { gridWalls[gridLocation][2] = 1; }

        }
        else if (heading == 'S') {

            if (obsticalForward == 'N') { gridWalls[gridLocation][2] = 0; }
            else { gridWalls[gridLocation][2] = 1; }

            if (obsticalLeft == 'N') { gridWalls[gridLocation][1] = 0; }
            else { gridWalls[gridLocation][1] = 1; }

            if (obsticalRight == 'N') { gridWalls[gridLocation][3] = 0; }
            else { gridWalls[gridLocation][3] = 1; }

        }
        else if (heading == 'W') {
            if (obsticalForward == 'N') { gridWalls[gridLocation][3] = 0; }
            else { gridWalls[gridLocation][3] = 1; }

            if (obsticalLeft == 'N') { gridWalls[gridLocation][2] = 0; }
            else { gridWalls[gridLocation][2] = 1; }

            if (obsticalRight == 'N') { gridWalls[gridLocation][0] = 0; }
            else { gridWalls[gridLocation][0] = 1; }
        }
